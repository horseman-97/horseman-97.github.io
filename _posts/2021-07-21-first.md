...
- 왜 그럴까? 공기 중이나 보드 내 다른 기기들에 전하가 남아 있기 때문에, 0과 1로 완벽하게 나누어지지 않고, <br/>0의 상태라고 해도 약 0.3  정도의 전위를 유지한다고 알려져 있다. 즉 값이 명확히 0과 1로 나누어지지 않는다. 이 현상을 <br/>[floating](https://en.wikipedia.org/wiki/Floating_ground) 현상이라 한다.
